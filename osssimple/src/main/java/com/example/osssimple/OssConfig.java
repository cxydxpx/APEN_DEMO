...
public class OssConfig {
    ...
    /**
     * 'access_id' => 'LTAIXyjtqrxy7fsn',
     * 'access_key' => 'aNbJRyv43zDucdnchT5g2gHrMxOWPQ',
     * 'bucket' => 'dfxiaoxiang',
     * 'endpoint' => 'oss-cn-hangzhou.aliyuncs.com',
     * // OSS 外网节点或自定义外部域名 //oss-cn-hangzhou-internal.aliyuncs.com
     * 'bucket' => 'dfxiaoxiang',
     * 'endpoint' => 'oss-cn-hangzhou.aliyuncs.com'
     */
    ...
    public static final String STS_SERVER_URL = "https://m.xxfx.ltd/sts-server/sts.php";//STS 地址

    public static final String BUCKET_NAME = "dfxiaoxiang";
    public static final String OSS_ACCESS_KEY_ID = "LTAIXyjtqrxy7fsn";
    public static final String OSS_ACCESS_KEY_SECRET = "aNbJRyv43zDucdnchT5g2gHrMxOWPQ";
